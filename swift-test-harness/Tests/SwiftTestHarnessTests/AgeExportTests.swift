...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Age.swiftmodule/`
...
//      `import Age` above would fail at compile time.
//
//   2. The static archive `libAge.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Age" }` and
//      `flattenPackage = "io.github.kotlinmania.age"` configuration in
...
final class AgeExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Age swift module imported cleanly")
    }
}
