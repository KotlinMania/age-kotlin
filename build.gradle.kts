...
kotlin {
    ...
    val xcf = XCFramework("Age")

    macosArm64 {
        binaries.framework { baseName = "Age"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Age"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Age"
        flattenPackage = "io.github.kotlinmania.age"
    }

    android {
        namespace = "io.github.kotlinmania.age"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "age-kotlin", version.toString())

    pom {
        name.set("age-kotlin")
        description.set("Kotlin Multiplatform port of str4d/rage - [BETA] A simple, secure, and modern encryption library")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/age-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/age-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/age-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/age-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAgeXCFramework",
    "assembleAgeDebugXCFramework",
    "assembleAgeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAgeXCFramework",
    "assembleReleaseIosFatFrameworkForAgeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAgeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAgeXCFramework",
    "assembleDebugMacosFatFrameworkForAgeXCFramework",
    "assembleReleaseMacosFatFrameworkForAgeXCFramework",
    "assembleDebugTvosFatFrameworkForAgeXCFramework",
    "assembleReleaseTvosFatFrameworkForAgeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAgeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAgeXCFramework",
    "assembleDebugWatchosFatFrameworkForAgeXCFramework",
    "assembleReleaseWatchosFatFrameworkForAgeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAgeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAgeXCFramework",
