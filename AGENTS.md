...
This file is the quick-reference operating contract for age-kotlin. The longer
...
age-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`age`](https://crates.io/crates/age). Upstream Rust is the behavioral oracle while the
